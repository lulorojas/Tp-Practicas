# 🎮 JuegoContador_Claude

JuegoContador_Claude es una aplicación web interactiva construida con React, TypeScript y CSS puro. El objetivo es hacer la mayor cantidad de clics posibles en 5 segundos.
